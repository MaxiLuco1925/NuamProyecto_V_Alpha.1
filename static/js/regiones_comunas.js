document.addEventListener('DOMContentLoaded', function() {
        ...
        "regiones": [
            ...
            },
            {
                ...
                "comunas": [
                    ...
                    {"codigo": "01201", "nombre": "Pozo Almonte"},
                    {"codigo": "01401", "nombre": "Camiña"},
                    {"codigo": "01402", "nombre": "Colchane"},
                    {"codigo": "01403", "nombre": "Huara"},
                    {"codigo": "01404", "nombre": "Pica"}
                ]
            },
            {
                "codigo": "02",
    ...
    // ✅ 2. Escuchar cambios y llenar comunas
    if (regionSelect) {
        regionSelect.addEventListener('change', function() {
            ...
            if (!regionCodigo) {
                comunaSelect.innerHTML = '<option value="">Primero seleccione región</option>';
                return;
            }

            const regionSeleccionada = regionesData.regiones.find(
